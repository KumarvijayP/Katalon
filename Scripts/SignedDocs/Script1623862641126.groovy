...
WebUI.click(findTestObject('Object Repository/Page_Docs To Sign - Bernstein/a_Signed Docs'))

WebUI.click(findTestObject('Object Repository/Page_Docs To Sign - Bernstein/a_Signed Docs'))

WebUI.click(findTestObject('Object Repository/Page_Docs To Sign - Bernstein/i_'))

WebUI.click(findTestObject('Object Repository/Page_Docs To Sign - Bernstein/a_Global Disruptor Series - DBT'))
